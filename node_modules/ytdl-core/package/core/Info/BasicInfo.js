...
async function _getBasicInfo(id, options, isFromGetInfo) {
    ...
    const SIGNATURE_TIMESTAMP = parseInt((await getSignatureTimestamp(HTML5_PLAYER_URL, options)) || ''), PLAYER_API_PARAMS = {
        ...
        options,
    }, { isMinimalMode, responses: PLAYER_RESPONSES } = await Player_1.default.getApiResponses(PLAYER_API_PARAMS, options.clients), PLAYER_RESPONSE_ARRAY = Object.values(PLAYER_RESPONSES) || [], NEXT_RESPONSES = await Next_1.default.getApiResponses(PLAYER_API_PARAMS), VIDEO_INFO = {
        videoDetails: {},
        relatedVideos: [],
        formats: [],
        full: false,
